...
> `supabase_migrations.schema_migrations`) : **les entrées jusqu'à la 39 sont
> appliquées** (39 vérifiée en base le 2026-08-16), entrée 38 comprise (`vault_service_role_key` : `cron.job` ne
